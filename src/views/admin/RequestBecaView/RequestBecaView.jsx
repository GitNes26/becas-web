                                                ...
                                                rows={[
                                                   {
                                                      ...
                                                      occupation: "Ocupado",
                                                      monthly_income: 1,
                                                      actions: <ButtonsAction id={1} name={"madre"} active={true} />
                                                   },
                                                   {
                                                      relationship: <Input value={"Madre"} />,
                                                      age: <Input value={8} type="number" />,
                                                      occupation: <Input value={"Ocupado"} />,
                                                      monthly_income: <Input value={1} type="number" />,
                                                      actions: <ButtonsAction id={1} name={"madre"} active={true} />
                                                   }
                                                ]}
                                             /> */}
